      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="flex items-center">
              <h2 className="text-xl font-semibold bg-clip-text text-transparent bg-gradient-to-r from-black to-gray-700">
                Genius<span className="text-primary">AI</span>
              </h2>
            </Link>
            <p className="mt-2 text-sm text-foreground/70 max-w-md">
              The most advanced conversational AI platform for creators, developers, and thinkers.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-8 md:gap-12">
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li><Link to="/trial" className="text-foreground/70 hover:text-primary transition-colors">Try Pro</Link></li>
                <li><Link to="/login" className="text-foreground/70 hover:text-primary transition-colors">Sign In</Link></li>
              </ul>
            </div>
            <div>
        ...
        <div className="mt-12 pt-6 border-t border-border/50 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-foreground/50">
            &copy; {currentYear} GeniusAI. All rights reserved.
          </p>
